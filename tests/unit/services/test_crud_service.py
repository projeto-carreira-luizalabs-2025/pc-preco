...
class TestCrudService:
    ...
    def repository_mock(self):
        ...
        async def update(entity_id, entity):
            if entity_id == UUID("00000000-0000-0000-0000-000000000001"):
                return SampleEntity(id=entity_id, name=entity.name, value=entity.value)
            return None
    ...
    @pytest.mark.asyncio
    async def test_find_by_id_not_found(self, service, repository_mock):
        """Deve retornar None ao buscar por um ID inexistente."""
