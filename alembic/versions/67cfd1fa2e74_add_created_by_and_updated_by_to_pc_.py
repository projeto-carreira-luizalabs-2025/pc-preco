...
def upgrade() -> None:
    ...
    op.add_column('pc_preco_historico', sa.Column('created_by', postgresql.JSONB, nullable=False, server_default='{}'))
    op.add_column('pc_preco_historico', sa.Column('updated_by', postgresql.JSONB, nullable=False, server_default='{}'))
