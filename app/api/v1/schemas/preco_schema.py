...
class PrecoSchema(SchemaType):
    ...
    seller_id: str = Field(..., description="Identificador único do seller", json_schema_extra={'example': "seller123"})
    sku: str = Field(..., description="Código SKU do produto", json_schema_extra={'example': "SKU001"})
    preco_de: int = Field(
        ...,
    ...
    preco_por: int = Field(
        ...
        json_schema_extra={'example': 8500},
        gt=0,
    )
...
class PrecoUpdate(SchemaType):
    ...
    preco_por: int = Field(
        ...
        json_schema_extra={'example': 9500},
        gt=0,
    )
